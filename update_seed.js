...
const data = [
  ...
  { series: "Bereshit", match: "Nóaj", desc: "Un mundo en crisis y una oportunidad de reconstrucción. La historia del arca y la importancia de hacer lo correcto incluso cuando nadie más lo hace.", dur: "6:45", chars: ["Aharon"] },
  ...
  { series: "Bereshit", match: "Sará", desc: "Historias de continuidad, legado y decisiones que construyen el futuro.", dur: "6:05", chars: ["Avraham", "Aharon"] },
  ...
  { series: "Bereshit", match: "Vaishlaj", desc: "Enfrentar el pasado, reconciliarse y avanzar con una nueva visión.", dur: "6:40", chars: ["Aharon"] },
  ...
  { series: "Shemot", match: "Vaerá", desc: "Las primeras señales de cambio aparecen. Una confrontación que empieza a revelar que la realidad puede transformarse.", dur: "6:20", chars: ["Arush", "Ezra"] },
  { series: "Shemot", match: "Bo", desc: "Momentos decisivos que marcan el camino hacia la libertad. Prepararse para lo que está por venir.", dur: "6:10", chars: ["Arush"] },
  ...
  { series: "Shemot", match: "Mishpatim", desc: "Las reglas que construyen una sociedad. Cómo los detalles definen la convivencia.", dur: "6:25", chars: ["Aharon"] },
  ...
  { series: "Shemot", match: "Tetzavé", desc: "El detalle, el orden y la constancia en lo que se construye día a día.", dur: "6:15", chars: ["Aharon"] },
  ...
  { series: "Vaikra", match: "Vaikrá", desc: "Un llamado que invita a acercarse. Entender que la conexión comienza con la intención.", dur: "6:00", chars: ["Arush", "Ezra"] },
  { series: "Vaikra", match: "Tzav", desc: "La constancia en las acciones transforma lo cotidiano en algo significativo.", dur: "6:10", chars: ["Aharon"] },
  ...
  { series: "Vaikra", match: "Tazria", desc: "El inicio de nuevos procesos y la importancia de lo que ocurre desde el principio.", dur: "6:05", chars: ["Benny"] },
  { series: "Vaikra", match: "Metzora", desc: "Las palabras tienen impacto. Aprender a cuidar lo que decimos y cómo lo decimos.", dur: "6:15", chars: ["Keter"] },

  { series: "Sipurei Pesaj", match: "Pe-Raj", desc: "El inicio del sufrimiento en Egipto y cómo comenzó la esclavitud del pueblo.", dur: "5:30", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Señales", desc: "Las plagas comienzan a cambiar la historia y mostrar que nada es casualidad.", dur: "5:50", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Noche", desc: "Una noche distinta a todas, llena de significado y preparación para la libertad.", dur: "6:10", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Mar", desc: "El momento decisivo: cruzar hacia lo desconocido y confiar completamente.", dur: "6:20", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Hashgajá", desc: "Las plagas comienzan a cambiar la historia y mostrar que nada es casualidad. (¿Cómo una niña de 3 años salvó al pueblo judío?)", dur: "5:50", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Augurio", desc: "Una noche distinta a todas, llena de significado y preparación para la libertad. (¿Por qué Moshé no podía hablar bien?)", dur: "6:10", chars: ["Arush"] },
  { series: "Sipurei Pesaj", match: "Gezerá", desc: "El momento decisivo: cruzar hacia lo desconocido y confiar completamente. (¡La espada de Faraón se ROMPIÓ!)", dur: "6:20", chars: ["Arush"] },
  ...
  { series: "Cuentos", match: "Todo es para bien", desc: "Una historia que revela cómo incluso lo inesperado tiene un propósito.", dur: "4:40", chars: ["Keter", "Arush"] },
