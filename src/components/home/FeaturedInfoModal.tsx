      ...
      {isOpen && video && (
        <div className="fixed inset-0 z-[100] flex justify-center items-center p-2 sm:p-6">
          ...
          <motion.div 
            ...
            className="bg-surface w-full max-w-4xl max-h-[95vh] sm:max-h-[90vh] rounded-3xl overflow-y-auto shadow-2xl relative z-10 border border-white/5 scrollbar-hide"
          >
